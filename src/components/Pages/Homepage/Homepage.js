...
export default function Homepage() {
	...
	return (
		...
		<div className="homepage-container">
			...
			<Carousel>
				<Carousel.Item>
					<img className="d-block w-100" src={herringbone} alt="First slide" />
				...
				<Carousel.Item>
					...
					<Carousel.Caption className="carousel-text">
						...
						<p>
							We work with any non-profit or state-funded organization to access
			...
			<div className="homepage-intro">
				...
				<p>
					For more than 25 years, Parsons Floors has been involved in the design
					and installation of various types of floors. We are equipped with a
					design department and sales office that can assist you with the
					selection, installation, and upkeep of all kinds of flooring,
					including personalized design projects.
				</p>
				<p>
					Our exclusive showroom is designed to offer you personalized service.
					We are situated in Garden City, New York, and boast a vast range of
					products to choose from. Schedule an appointment with us today and
					witness how we can transform your flooring ideas into a successful
					project!
				</p>
			...
			<div className="company-info-section-img">	
				...
				<p>Our in-house installers are professionally trained to meet and exceed your expectations.</p>
				</div>
				</div>
				<div className="company-info">
				<img src={womenCarpet1} alt="" className="company-info-image"/>
				<div className="company-info-text-experts">
				<h4>Creative Experts</h4>
				<p>Meet our design team to assist in helping you create the best design for your needs.</p>
				</div>
				</div>
				<div className="company-info">
				<img src={carpetInstall} alt="" className="company-info-image"/>
				...
				<div className="manufacturers-section">
					...
					<p>Rest assured that when you choose our commercial flooring options from our exclusive collections, you can expect top-notch quality that will not only elevate the professional aesthetics of your space but also add significant value to your commercial property.</p>
				<LogoCarousel />
				</div>
				</div>
