  ...
  return (
    <div className="services-page">
      ...
      <section className="hero-section">
        <div className="hero-overlay">
          <div className="hero-content">
            <p className="hero-subtitle">Flooring Specialists</p>
        ...
        <div className="container">
          <div className="intro-grid">
            <div className="intro-text">
              <h2>Our Services</h2>
              <p>
                Parsons Flooring specialists walk you through every phase of a comprehensive 
                commercial flooring project from initial planning to final completion. Our team 
                collaborates with all stakeholders to understand your unique requirements. We 
                perform detailed site evaluations to determine optimal solutions. Implementation 
                follows industry best practices to ensure timely delivery within budget. Our 
                commitment to exceptional quality, creative problem-solving, and value-driven 
                service has established us as a trusted ally to architects, interior designers, 
        ...
        <div className="container">
          ...
          <div className="service-card">
            <div className="service-image">
              <img 
                src="/images/commercial-flooring.jpg" 
          ...
          <div className="service-card reverse">
            <div className="service-image">
              <img 
                src="/images/sports-flooring.jpg" 
          ...
          <div className="service-card">
            ...
            <div className="service-content">
              ...
              <p>
                ...
                offering extended service life.
              </p>
              <p>
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>
              Our superior products and expertise in commercial flooring have established 
              Parsons Flooring as an industry leader. This excellence is why over 90% of 
              our projects come from returning clients and word-of-mouth recommendations. 
              For quality work you can trust, we should be your first contact!
            </p>
      ...
      <section className="experts-section">
        <div className="container">
          <h2>Our flooring specialists are ready to assist with your questions.</h2>
        </div>
      </section>
    </div>
  );
